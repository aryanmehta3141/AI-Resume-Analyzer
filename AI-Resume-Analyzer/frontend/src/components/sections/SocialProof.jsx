    ...
    <section className="py-12 md:py-16">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl border border-white/5 bg-zinc-900/25 p-8 md:p-12 backdrop-blur-md shadow-[0_12px_40px_rgba(0,0,0,0.4)]">
          ...
          <div className="grid grid-cols-2 gap-y-8 gap-x-6 sm:gap-x-8 lg:grid-cols-4 lg:gap-x-12 relative z-10">
            {stats.map((stat) => (
              <div key={stat.label} className="text-center group transition-all duration-300 hover:scale-105">
                <p className="text-3xl font-extrabold tracking-tight bg-gradient-to-r from-white via-zinc-100 to-zinc-300 bg-clip-text text-transparent sm:text-4xl md:text-5xl drop-shadow-[0_2px_10px_rgba(255,255,255,0.05)]">
                  {stat.value}
                </p>
