  ...
  return (
    <section className="py-24 md:py-32">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl border border-white/5 bg-zinc-900/25 px-6 py-14 text-center sm:px-8 md:px-16 md:py-20 backdrop-blur-md shadow-[0_12px_40px_rgba(0,0,0,0.4)]">
